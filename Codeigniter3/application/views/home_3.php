...
if ($user) {
	...
	$user_ufa = (!empty($ufa)) ? $ufa['username'] : null;
	$pass_ufa = (!empty($ufa)) ? $ufa['password'] : null;
...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="60x60" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="72x72" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="76x76" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="114x114" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="120x120" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="144x144" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="152x152" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="apple-touch-icon" sizes="180x180" href="<?= $baseurl . $assets ?>/images/logo.png">
	<link rel="icon" type="image/png" sizes="192x192" href="<?= $baseurl . $assets ?>/images/logo.png">
...
<body>
		...
		<div class="container-fluid -inner-container">
			...
			<div id="headerBrand">
				<a class="navbar-brand" href="/">
					<img class="-logo -default" src="<?= $baseurl . $assets ?>/images/logo.png" alt="EZ Slot">
					<img class="-logo -invert" src="<?= $baseurl . $assets ?>/images/logo.png" alt="EZ Slot">
				</a>
			</div>
				...
				<div class="-inner-wrapper">
					<div class="-brand-heading">
						<a href="/" class="-logo-img js-theme-switcher-toggle" data-toggle="modal" data-target="#themeSwitcherModal">
							<img data-src="<?= $baseurl . $assets ?>/images/logo.png" src="<?= $baseurl . $assets ?>/images/default-loading-normal.png" alt="EZ Slot" class="-logo lazyload">
									...
									<div class="d-flex dropdown -logged-container">
											...
											<div class="d-flex">
												<div class="mr-2 d-flex js-logged-sidebar">
													<div class="x-profile-image d-sm-inline-block d-none">
														<img class="img-fluid mb-1" src="<?= $baseurl . $assets ?>/images/profile_icon_level_021.png" alt="icon deposit white">
													</div>
										...
										<div class="--deposit d-none d-lg-block">
											<a href="#" class="text-white" id="ufadeposit" data-toggle="modal" data-target="#modal-deposit">
												<div class="d-flex flex-column justify-content-center h-100 px-3">
													<img class="img-fluid mt-2" src="<?= $baseurl . $assets ?>/images/ic_deposit_white2.png" alt="icon deposit white" width="35">
										...
										<div class="--withdraw d-none d-lg-block">
											<a href="#" class="text-white" id="ufawithdraw" data-toggle="modal" data-target="#modal-withdraw">
												<div class="d-flex flex-column justify-content-center  h-100 px-3">
													<img class="img-fluid mt-2" src="<?= $baseurl . $assets ?>/images/ic_withdraw_white2.png" alt="icon deposit white" width="35">
										...
										<div class="--wheelspin d-none d-lg-block">
											<a href="#" class="text-white" id="wheelspinufa">
												<div class="d-flex flex-column justify-content-center  h-100 px-3">
													<img class="img-fluid mt-2" src="<?= $baseurl . $assets ?>/images/icon_wheelspin.png" alt="icon wheelspin white" width="35">
			...
			<div class="row -contents-wrapper ">
				...
				<div class="col-12 col-md-6 -left-content -default">
					<div class="x-index-image-cover-inner-container">
						...
						<img src="<?= $baseurl . $assets ?>/images/logo.png" class="-games-girls thelogoleft" alt="<?= $webname; ?> รูปผู้หญิงน่ารัก games cute girl image png">
					</div>
				</div>
				...
				<div class="hidesmoketop">
					<img src="<?= $baseurl . $assets ?>/images/ez-slot-cloud.png" class="-cloud-cartoon-default-customize -item-1" alt="<?= $webname; ?> รูปก้อนเมฆ">
					<img src="<?= $baseurl . $assets ?>/images/ez-slot-cloud.png" class="-cloud-cartoon-default-customize -item-2" alt="<?= $webname; ?> รูปก้อนเมฆ">
				</div>

			</div>
		</div>

		<div class="-cover-foreground d-none d-md-block" style="background-image: url('<?= $assets ?>images/ez-slot-cover-foreground.png')"></div>
		<div class="-cover-foreground -mini d-md-none" style="background-image: url('<?= $assets ?>images/ez-slot-cover-foreground-mobile.png')"></div>
	</div>
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/952-vertical.png" src="<?= $baseurl . $assets ?>/images/game/952-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/985-vertical.png" src="<?= $baseurl . $assets ?>/images/game/985-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/955-vertical.png" src="<?= $baseurl . $assets ?>/images/game/955-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/958-vertical.png" src="<?= $baseurl . $assets ?>/images/game/958-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/961-vertical.png" src="<?= $baseurl . $assets ?>/images/game/961-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5573-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5573-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5687-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5687-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5643-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5643-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5585-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5585-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5489-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5489-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5523-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5523-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5491-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5491-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/5344-vertical.png" src="<?= $baseurl . $assets ?>/images/game/5344-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/949-vertical.png" src="<?= $baseurl . $assets ?>/images/game/949-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
						...
						<div class="x-game-list-item-macro js-game-list-toggle -normal " data-status="">
							<div class="-inner-wrapper">
								...
								<picture>
									...
									<img class="-cover-img img-fluid lazyloaded" alt="rich88 cover image png" width="216" height="216" data-src="<?= $baseurl . $assets ?>/images/game/964-vertical.png" src="<?= $baseurl . $assets ?>/images/game/964-vertical.png">
								</picture>
								<div class="-overlay">
									<div class="-overlay-inner">
										<div class="-wrapper-container">
			...
			<div class="-games-splitter-zone-container -anon animated fadeInUp" data-animatable="fadeInUp" data-delay="250">
								...
								<div class="x-game-list-item-macro js-game-list-toggle -normal -cannot-entry -untestable" data-status="-cannot-entry -untestable">
									<div class="-inner-wrapper">
										<div class="x-game-badge-image -normal ">
											<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic-master-key.png" class="-img" alt="badge game">
										</div>
										<picture>
				...
				<div class="-right-side">
					<a href="/member/casinos" class="-button-wrapper animated fadeInUp" data-animatable="fadeInUp" data-delay="100">
						...
						<img data-src="<?= $baseurl . $assets ?>/images/ez-slot-girl-china.png" class="-china-girl lazyloaded" alt="Ezbet china girl image png" src="<?= $baseurl . $assets ?>/images/ez-slot-girl-china.png">
						<img data-src="<?= $baseurl . $assets ?>/images/ez-slot-dice-dual.png" class="-dice-dual lazyloaded" alt="Ezbet two dices image png" src="<?= $baseurl . $assets ?>/images/ez-slot-dice-dual.png">
					</a>
				</div>
			</div>
		</div>
					...
					<div class="d-flex -anon-menu-wrapper">
						<div class="-btn-container -left">
							<a href="https://line.me/R/ti/p/<?= $line ?>" class="btn btn-lg btn-plain-primary">
								<img src="<?= $baseurl . $assets ?>/images/ez-slot-menu-bottom-ic-promotion.png" alt=" โปรโมชั่นสล็อต โปรโมชั่นคาสิโน อันดับ 1" class="-icon img-fluid" width="90" height="90">
						...
						<div class="-btn-container -center">
							...
							<a href="#" data-toggle="modal" data-target="#RegisterModal" class="btn btn-lg btn-plain-lobby">
								<div class="-img-container">
									<img src="<?= $baseurl . $assets ?>/images/sud.png" alt="สมัครสมาชิกเว็บสล็อตออนไลน์ สมัครสมาชิกเว็บคาสิโนออนไลน์" class="-icon" width="109" height="150">
								</div>
						...
						<div class="-btn-container -right">
							<a class="btn btn-lg btn-plain-secondary" href="#loginModal" data-toggle="modal" data-target="#loginModal">
								<img src="<?= $baseurl . $assets ?>/images/ez-slot-menu-bottom-ic-event.png" alt="สล็อตออนไลน์ สิทธิพิเศษสล็อตออนไลน์ ดูหนังออนไลน์ฟรี ไม่มีโฆษณาคั่น" class="-icon img-fluid" width="90" height="90">
					...
					<div class="d-flex -anon-menu-wrapper">
						<div class="-btn-container -left">
							<a href="#" class="btn btn-lg btn-plain-primary" id="wheelspinufa_mobile">
								<img src="<?= $baseurl . $assets ?>/images/icon_wheelspin.png" alt=" โปรโมชั่นสล็อต โปรโมชั่นคาสิโน อันดับ 1" class="-icon img-fluid" width="90" height="90">
					...
					<div class="modal-body" style="top: 0px;">
						<div class="x-login-form">
							<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
								<img src="<?= $baseurl . $assets ?>/images/registermascotgiant333.png" alt="">
								<form id="login-form" class="js-login-form x-header-login-form">
									...
									<div class="-x-input-icon mb-3 flex-column">
										<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic_phone.png" class="-icon" alt="login" width="12">
									...
									<div class="-x-input-icon flex-column">
										<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic-lock-input.png" class="-icon" alt="password" width="13">
					...
					<div class="modal-body" style="top: 0px;">
						<div class="x-login-form">
							<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
								<img src="<?= $baseurl . $assets ?>/images/registermascotgiant333.png" alt="">
								<div class="-x-input-icon mb-3 flex-column">
									<img src="<?= $baseurl . $assets ?>/images/user.png" class="-icon" alt="login" width="20">
									<input type="text" id="fname" name="fname" class="form-control x-form-control" placeholder="ชื่อ">
								</div>
								<div class="-x-input-icon mb-3 flex-column">
									<img src="<?= $baseurl . $assets ?>/images/password.png" class="-icon" alt="login" width="20">
								...
								<div class="-x-input-icon mb-3 flex-column" style="display: none;">
									<img src="<?= $baseurl . $assets ?>/images/gift.png" class="-icon" alt="login" width="20">
		...
		<div class="x-modal modal" id="modal-deposit" tabindex="-1" role="dialog" data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true" style="display: none;" aria-hidden="true">
			<div class="modal-dialog -modal-size -modal-big" role="document" style="padding-top: 60px;">
				<div class="modal-content -modal-content">
								...
								<div class="row">
											...
											<div class="text-center d-flex flex-column">
												...
												?>
													<div class="mb-3">
														<div class="media m-auto d-inline-flex">
															<img src="<?= $baseurl . $assets ?>/image/scb2.png" alt="bank-bay" width="50px" class="rounded-circle mr-3">
												...
												<div class="-danger-zone">
													<div class="-icon-wrapper">
														<img src="<?= $baseurl . $assets ?>/images/ic-alert.png" alt="Alert icon png" class="-img">
													</div>
									...
									<div class="col d-flex flex-column animated fadeInModal" data-animatable="fadeInModal">
										...
										<div class="-deposit-preview text-center">
											<img src="<?= $baseurl . $assets ?>/images/ic_chip_deposit.png" class="img-fluid mb-3" alt="deposit" width="100">
					...
					<img src="<?= $baseurl . $assets ?>/images/border-modal.png" class="img-fluid d-lg-block d-none -border-bottom-modal" alt="">
				</div>
			</div>
		</div>
		<!--###################################### ฝากเงิน ######################################-->
						...
						<div class="modal-body" style="top: 5px;">
							<div class="form-group mt-1 ml-2 mr-2 mb-2">
								<div class="d-flex justify-content-center">
									<div class="media p-2">
										<div class="bank-box">
											<img src="<?= $baseurl . $assets ?>images/bank2/<?= $info['bank'] ?>.jpg" width="50px" height="50px">
										</div>
						...
						<div class="modal-body -modal-body" style="position: unset;">
							<div class="x-login-form">
								<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
									<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
										<div>
											<img src="<?= $baseurl . $assets ?>/images/profile-icon-lerge-black.png" class="mx-auto d-block mb-2 mt-2" alt="giftbox-icon" width="50">
											<p class="text-center">
											...
											<div id="panel" data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
												...
												<div class="d-flex justify-content-center">
													<div class="mt-3 media p-2">
														<div class="bank-box">
															<img src="<?= $baseurl . $assets ?>images/bank2/<?= $info['bank'] ?>.jpg" width="70px" height="70px">
														</div><br>
														<div class="media-body ml-2">
				...
				<div class="modal-body -modal-body">
					<div class="d-flex -alert-body">
						<div class="text-center mr-3 -alert-body-wrapper">
							<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic-alert-success.png" alt="SUCCESS" class="-img-alert js-ic-success img-fluid">
							<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic-alert-failed.png" alt="FAIL" class="-img-alert js-ic-fail img-fluid">
						</div>
						...
						<ul class="nav">
							<li class="nav-item -ez-casino animated fadeInUp" data-animatable="fadeInUp" data-delay="100">
								<a href="" class="nav-link" rel="ugc,nofollow">
									<img src="<?= $baseurl . $assets ?>/images/casi.png" alt="EZ-Casino-ทางเข้าคาสิโนสดออนไลน์ logo png" class="-logo" width="50" height="50">
							...
							<li class="nav-item -ez-slot -active animated fadeInUp" data-animatable="fadeInUp" data-delay="100">
								<a href="/spin/spintowin" class="nav-link" rel="ugc,nofollow">
									<img src="<?= $baseurl . $assets ?>/images/game.png" alt="EZ-Slot-ทางเข้าสล็อตออนไลน์-เครดิตฟรี logo png" class="-logo" width="50" height="50">
	...
	<div class="x-contact-us">
		<a href="https://line.me/R/ti/p/<?= $line ?>" class="-line-contact-button-container js-line-contact-hover" target="_blank" rel="noopener">
			<img src="<?= $baseurl . $assets ?>/images/ez-slot-ic-contact-line.png" class="-ic" alt="<?= $webname; ?> รูปโลโก้ Line png">
	...
	<footer class="x-footer -logged">
		<div class="-inner-wrapper lazyload">
			<div class="container -image-wrapper">
				<img src="<?= $baseurl . $assets ?>/images/logo.png" alt="ez-bet" class="img-fluid -img">
				...
				<div class="container -image-wrapper">
					...
					<div class="row -box-wrapper">
						<div class="col-md-4">
							<div class="-box">
								<div class="-content">
									<img src="<?= $baseurl . $assets ?>/images/ic_register.png" alt="icon png" class="-ic-register">
									<div class="-desc-wrap">
						...
						<div class="col-md-4">
							<div class="-box">
								<div class="-content">
									<img src="<?= $baseurl . $assets ?>/images/ic_otp.png" alt="icon png" class="-ic-otp">
									<div class="-desc-wrap">
						...
						<div class="col-md-4">
							<div class="-box">
								<div class="-content">
									<img src="<?= $baseurl . $assets ?>/images/ic_bank.png" alt="icon png" class="-ic-bank">
									<div class="-desc-wrap">
					...
					success: function(data) {
						if (data.status) {
							if (data.credit) {
								...
								document.getElementById('btn_wheelspin').innerHTML = `<button type="button" class="btn btn-primary btn-lg btn-block" disabled>ต้องมียอดเงินขั้นต่ำ ${data.lowcredit} ถึงหมุนฟรีได้</button>`;
							}
