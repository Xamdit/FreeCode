! function (e) {
    ...
    "sV/x": function (e, t, n) {
        ...
        $("body").on("click", ".js-btn-change-pass", function (e) {
            ...
            0 == r ? ($(".form-password").html('<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal"><div class="form-group mt-1 ml-1 mr-1 mb-2"><input class="form-control js-old-password" placeholder="รหัสผ่านปัจจุบัน" name="old_password" pattern="[a-zA-Z0-9.+_#,$-]+"type="password"></div><div class="form-group mt-1 ml-1 mr-1 mb-2"><input class="form-control js-new-password" pattern="[a-zA-Z0-9.+_#,$-]+" placeholder="รหัสผ่านใหม่" name="password" type="password"></div><div class="form-group mt-1 ml-1 mr-1 mb-3"><input class="form-control js-confirm-password" pattern="[a-zA-Z0-9.+_#,$-]+" placeholder="พิมพ์รหัสผ่านใหม่อีกครั้ง" name="password_confirmation" type="password"></div><div class="ml-1 mr-1"><a href="#" class="btn btn-primary btn-lg btn-block mb-4 js-change-password" title="ยืนยัน">ยืนยัน</a></div></div>'), r = 1) : ($(".form-password").html(""), r = 0)
